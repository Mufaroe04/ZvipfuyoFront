...
const HealthAndTreatments: React.FC = () => {
  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen className="ion-padding">
        <Container maxWidth="lg">
          <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 3, mt: 2 }}>
            <Box>
              <Typography variant="h5" fontWeight="bold">Clinical Records</Typography>
              <Typography variant="body2" color="text.secondary">Tracking medical history and expenses</Typography>
            </Box>
            <Button 
              ...
              startIcon={<IonIcon icon={addOutline} />}
              onClick={() => history.push("/health/add")}
              sx={{ borderRadius: '8px', bgcolor: '#18774c', '&:hover': { bgcolor: '#14633f' } }}
            >
              New Record
            </Button>
          </Stack>
          ...
          <HealthListGrid records={healthRecords} loading={loading} />
        </Container>
      </IonContent>
    </IonPage>
  );
