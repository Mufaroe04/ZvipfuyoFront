...
import { Task } from '../../../types/types'; // Adjust path according to your project structure

interface OperationsProps {
  upcomingTasks?: Task[];
  taskStats: { due_today: number; overdue: number };
  transferStats: { pending: number; intransit: number; incoming: number };
}

export const OperationsSummary: React.FC<OperationsProps> = ({
  upcomingTasks,
  taskStats,
  transferStats
}) => (
