...
export const PregnancyAlertBanner = ({ animal, onRegisterBirth }: { animal: any, onRegisterBirth: () => void }) => {
  ...
  return (
    <Paper elevation={0} sx={{ p: 1, mb: 1, bgcolor: isOverdue ? '#fff1f0' : '#ffffff', border: isOverdue ? '1px solid #ffa39e' : '1px solid #ffe58f', borderRadius: '4px' }}>
      <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2} alignItems="center" justifyContent="space-between">
        ...
        <Stack direction="row" spacing={2} alignItems="center">
          <Box sx={{ textAlign: 'right' }}>
            <Typography variant="body1" fontWeight="black" sx={{ color: isOverdue ? '#cf1322' : '#d48806', lineHeight: 1 }}>
          ...
          <Button variant="contained" color={isOverdue ? "error" : "primary"} size="small" onClick={onRegisterBirth} sx={{ borderRadius: '4px', textTransform: 'none' }}>
            Register Birth
          </Button>
        </Stack>
      </Stack>
